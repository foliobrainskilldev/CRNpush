        ...
        productsToRender.forEach(prod => {
            ...
            tr.innerHTML = `
                ...
                <td class="actions-cell">
                    <button class="btn-action" title="Edit Product" onclick="window.editProduct(event, '${prod.id}')"><span class="iconify" data-icon="ph:pencil-simple-fill"></span></button>
                    <button class="btn-action delete" title="Delete Product" onclick="window.deleteProduct(event, '${prod.id}')"><span class="iconify" data-icon="ph:trash-fill"></span></button>
                </td>
            `;
