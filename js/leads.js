        ...
        leadsToRender.forEach(lead => {
            ...
            tr.innerHTML = `
                ...
                <td class="actions-cell">
                    <button class="btn-action" title="Edit Lead" onclick="window.editLead(${lead.id})"><span class="iconify" data-icon="ph:pencil-simple-fill"></span></button>
                    <button class="btn-action email" title="Send Email" onclick="window.sendEmail('${lead.email || ''}')"><span class="iconify" data-icon="ph:envelope-simple-fill"></span></button>
                    <button class="btn-action whatsapp" title="WhatsApp Message" onclick="window.sendWhatsApp('${lead.phone || ''}')"><span class="iconify" data-icon="ph:whatsapp-logo-fill"></span></button>
                    <button class="btn-action delete" title="Delete Lead" onclick="window.deleteLead(${lead.id})"><span class="iconify" data-icon="ph:trash-fill"></span></button>
                </td>
            `;
