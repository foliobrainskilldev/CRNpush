(() => {
        ...
        try {
            if (window.crmData && window.crmData.translations) {
                Object.assign(window.crmData.translations.en, {
                    ...
                    "clientDetail.mainContact": "Main Contact",
                    "clientDetail.emailAddress": "Email Address",
                    "clientDetail.phoneNumber": "Phone Number",
                    "clientDetail.documents": "Documents & Files",
                    "clientDetail.dragDrop": "Drag & Drop files here",
                    "clientDetail.timeline": "Activity Timeline",
                    "clientDetail.activeDeals": "Active Deals",
                    "clientDetail.pendingTasks": "Pending Tasks",
                    "clientDetail.filterAll": "All",
                    "clientDetail.filterNotes": "Notes",
                    "clientDetail.filterEmails": "Emails",
                    "clientDetail.filterCalls": "Calls",
                    "clientDetail.notePlaceholder": "Write a note, log a call...",
                    "clientDetail.typeNote": "Note",
                    "clientDetail.typeEmail": "Email Sent",
                    "clientDetail.typeCall": "Call Logged",
                    "clientDetail.typeMeeting": "Meeting",
                    "clientDetail.emptyDeals": "No active deals.",
                    "clientDetail.emptyTasks": "No pending tasks.",
                    "clientDetail.emptyHistory": "No history found.",
                    "clientDetail.simulationWarning": "Uploads are simulated for this demo"
                });

                Object.assign(window.crmData.translations.pt, {
                    "clientDetail.back": "Voltar aos Clientes",
                    "clientDetail.contactInfo": "Informação de Contacto",
                    "clientDetail.mainContact": "Contacto Principal",
                    "clientDetail.emailAddress": "Endereço de E-mail",
                    "clientDetail.phoneNumber": "Número de Telefone",
                    "clientDetail.documents": "Documentos e Ficheiros",
                    "clientDetail.dragDrop": "Arraste ficheiros para aqui",
                    "clientDetail.timeline": "Histórico de Atividades",
                    "clientDetail.activeDeals": "Negócios Ativos",
                    "clientDetail.pendingTasks": "Tarefas Pendentes",
                    "clientDetail.filterAll": "Todos",
                    "clientDetail.filterNotes": "Notas",
                    "clientDetail.filterEmails": "E-mails",
                    "clientDetail.filterCalls": "Chamadas",
                    "clientDetail.notePlaceholder": "Escreva uma nota, registe uma chamada...",
                    "clientDetail.typeNote": "Nota",
                    "clientDetail.typeEmail": "E-mail Enviado",
                    "clientDetail.typeCall": "Chamada Registada",
                    "clientDetail.typeMeeting": "Reunião",
                    "clientDetail.emptyDeals": "Sem negócios ativos.",
                    "clientDetail.emptyTasks": "Sem tarefas pendentes.",
                    "clientDetail.emptyHistory": "Nenhum histórico encontrado.",
                    "clientDetail.simulationWarning": "Uploads são simulados nesta demo"
                });
    ...
    function initTimeline() {
        clientNotes = [{
                ...
                type: 'note',
                text: {
                    en: 'Client showed interest in Q4 expansion.',
                    pt: 'Cliente demonstrou interesse em expandir no Q4.'
                },
                date: 'Today, 10:00 AM'
            },
            {
                ...
                type: 'email',
                text: {
                    en: 'Sent institutional presentation.',
                    pt: 'Enviada apresentação institucional.'
                },
            ...
            },
            {
                ...
                type: 'call',
                text: {
                    en: 'Technical alignment meeting held successfully.',
                    pt: 'Reunião de alinhamento técnico realizada com sucesso.'
                },
                date: 'Mar 10, 2026'
            }
        ];
        ...
        if (formAddNote) {
            formAddNote.addEventListener('submit', async (e) => {
                ...
                if (!noteInput.checkValidity() || noteInput.value.trim() === '') {
                    window.showToast("Please enter a valid note.", "warning");
    ...
    function renderTimeline(filter) {
        ...
        filtered.forEach(note => {
            ...
            if (note.type === 'email') {
                iconName = 'ph:envelope-simple-fill';
                iconClass = 'icon-email';
                typeLabel = t['clientDetail.typeEmail'] || 'Email';
            }
            if (note.type === 'call') {
                iconName = 'ph:phone-fill';
                iconClass = 'icon-call';
                typeLabel = t['clientDetail.typeCall'] || 'Call';
            }
            if (note.type === 'meeting') {
                iconName = 'ph:users-fill';
                iconClass = 'icon-meeting';
                typeLabel = t['clientDetail.typeMeeting'] || 'Meeting';
            }
    ...
    function initFileUpload() {
        ...
        async function handleFiles(files) {
            ...
            try {
                ...
                const lang = window.app ? window.app.currentLang : 'en';
                const msg = lang === 'pt' ? 'Upload simulado com sucesso (apenas interface local).' : 'File upload simulated (local UI only).';
        ...
        function uploadFile(file) {
            ...
            fileDiv.innerHTML = `
                ...
                <button class="btn-action" aria-label="Remove file" style="color:var(--danger); font-size:18px; border:none; background:transparent; cursor:pointer;" onclick="this.parentElement.remove()">
