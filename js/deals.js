            ...
            stageDeals.forEach(deal => {
                ...
                card.innerHTML = `
                    <div class="card-actions">
                        <button class="card-action-btn" onclick="window.editDeal(event, '${deal.id}')" title="Edit"><span class="iconify" data-icon="ph:pencil-simple-fill"></span></button>
                        <button class="card-action-btn del" onclick="window.deleteDeal(event, '${deal.id}')" title="Delete"><span class="iconify" data-icon="ph:trash-fill"></span></button>
                    </div>
