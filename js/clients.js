(() => {
    ...
    function renderClients(clientsToRender) {
        ...
        clientsToRender.forEach(client => {
            ...
            tr.setAttribute('aria-label', `View details for ${client.name}`);
            
            tr.onclick = () => window.viewClient(client.id);
            tr.onkeydown = (e) => {
                if (e.key === 'Enter') {
                    e.preventDefault();
                    window.viewClient(client.id);
                }
            };
            ...
            tr.innerHTML = `
                ...
                <td class="actions-cell">
                    <button class="btn-action" aria-label="Edit Client" title="Edit Client" onclick="window.editClient(event, '${client.id}')"><span class="iconify" data-icon="ph:pencil-simple-fill"></span></button>
                    <button class="btn-action delete" aria-label="Delete Client" title="Delete Client" onclick="window.deleteClient(event, '${client.id}')"><span class="iconify" data-icon="ph:trash-fill"></span></button>
                </td>
            `;
